			...
			<div class="personal">
				...
				<div class="main">
					...
					<div class="form-right-w3ls ">
						...
						<input type="text" class="top-up" name="address" id= "address" placeholder="Address" required="">
				...
				<div class="main">
						<div class="form-left-w3l">
								...
								<input class="buttom" type="text" id="phoneNumber" name="phoneNumber" placeholder="Phone Number" required="">
								<div class="clearfix"></div>
							</div>
					<div class="form-right-w3ls ">
						<input id="balance" name="balance" type="text" placeholder="0" required="">
					</div>

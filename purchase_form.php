				...
				<div class="information" id="information">
					...
					<div class="main" id="catalogue1">
						...
						<div class="form-right-w3ls ">
							...
							<input type="number" name="itemQnty1" id="itemQnty1"placeholder="Qnty" required="">
					...
					<div class="main" id="catalogue2">
						...
						<div class="form-right-w3ls ">
							...
							<input type="number" name="itemQnty2" id="itemQnty2" placeholder="Qnty" required="">
							<div class="clearfix"></div>
						</div>
					</div>
				</div>
		...
		<script>
			...
			function addRow(){
				...
				div.innerHTML = '<div class="form-left-w3l"> <input type="text" name="itemName'+String(childCount)+'" id="itemName'+String(childCount)+'"placeholder="Item" required=""></div>\
						<div class="form-right-w3ls "><input type="number" name="itemQnty'+String(childCount)+'" id="itemQnty'+String(childCount)+'" placeholder="Qnty" required="">\
			...
			function getTotal(){
				...
				for(var i=1;i<=count;i++){
					var num = document.getElementById('itemQnty'+String(i)).value;
					sum += Number(num);
				}
